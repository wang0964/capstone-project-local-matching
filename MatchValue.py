...
class Match:
    ...
    #     parten_df=self.df
    #     academic_course=self.input_txt
    #     scores=[]
        
    #     total_row = len(parten_df)
    #     current_row=0
        
    #     for j, prow in parten_df.iterrows():
    #         current_row += 1

    #         str1=prow['ProjectIdea']
    #         result = classifier(
    #                     str1, 
    #                     [academic_course],
    #                     hypothesis_template="The following text is related to {}.",
    #                     multi_label=True
    #         )
    #         scores.append( {'pID':prow['pID'],'score':result['scores'][0] })
    #         using_time = time.time() -start_time
    #         parent.rest_time= int((using_time / current_row) * (total_row- current_row))
